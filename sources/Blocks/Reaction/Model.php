...
/**
 * @internal
 * @phpstan-type Attributes array{inactiveColor?: string, activeColor?: string, showCount?: bool}
 */
final readonly class Model
{
    ...
    {
        $showCount = (bool) ($this->attributes['showCount'] ?? null);

        $this->context->merge(['showCount' => $showCount]);
    ...
    public function button(): Button
    {
        ...
        return Button::new($anchor, $showCount);
    }
}
