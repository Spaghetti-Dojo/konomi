...
Defines the custom database table schema for storing Konomi interactions, including its lifecycle management (creation on activation, removal on uninstall) and the orchestrating `Database` package.
